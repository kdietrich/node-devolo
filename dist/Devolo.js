    ...
    Devolo.prototype.getDevices = function (ids, callback) {
        ...
        self._api.fetchItems(ids, function (err, items) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                else if ((item.properties.deviceModelUID.indexOf('unk.model.Unknown:Device') > -1) && ((item.properties.prodID == '0x0001' && item.properties.prodTypeID == '0x8002') || // https://products.z-wavealliance.org/products/372
